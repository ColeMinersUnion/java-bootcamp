...
public class ReportService {
    ...
    public void displayBonusInsights() {
        ...
        double secondHighestSalary = employees.stream().map(e -> e.getSalary()).
        ...
        //Is there a way to do this in only one stream?
        ...
        String departmentWithHighestAvgSalary = avgSalaryByDept.entrySet().stream()
                .max(Map.Entry.comparingByValue())
                .map(Map.Entry::getKey)
                .orElse(null);

        //I will do the histogram later. I just need this to exist with a print statement for now.
        System.out.printf("Bonus Insights: \nSecond Highest Salary: %f\n" +
                "Longest Name: %s\n" +
                "Dempartment with Highest Average Salary: %s\n",
                secondHighestSalary, longestName, departmentWithHighestAvgSalary
        );
