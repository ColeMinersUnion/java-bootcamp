...
public class MemoryLeakDemo {
    ...
    private static void demonstrateLeak() {
        ...
        for(int i = 0; i < targetCount; i++){
            ...
            if(i % step == 0){
                ...
                MemoryMonitor.printMemoryReport("During Allocation (Leak)");
            }
        }
    ...
    private static void demonstrateFix() {
        ...
        MemoryMonitor.printMemoryReport("After Allocation (Fix)");
        // TODO: clear list, null it, trigger GC, print After GC
        employees.clear();
        employees = null;
        System.gc();

        MemoryMonitor.printMemoryReport("After Garbage Collection (Fix)");
        //throw new UnsupportedOperationException("TODO");
    }
